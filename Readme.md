...
```bash 
pkg install git 
git clone https://github.com/candradwicahyo/notes-app.git
```

## preview dan demo 

![preview](https://github.com/candradwicahyo/notes-app/blob/master/image.jpg)

[tekan link ini](https://candradwicahyo.github.io/notes-app) untuk mencoba demo